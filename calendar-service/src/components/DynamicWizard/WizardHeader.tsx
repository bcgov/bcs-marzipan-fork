...
import { Title2, Caption1, makeStyles, tokens, shorthands } from "@fluentui/react-components";
...
const useStyles = makeStyles({
  ...
  circle: {
    width: "24px", height: "24px", borderRadius: "9999",
        ...
        {steps.map((st, i) => {
          ...
          return (
            <div key={st.key} style={{ textAlign: "center" }}>
              <div className={[s.circle, active ? s.circleActive : "", done ? s.circleCompleted : ""].join(" ")}>
                {i + 1}
              </div>
