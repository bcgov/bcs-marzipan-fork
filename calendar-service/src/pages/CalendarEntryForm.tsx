    ...
    <form className={styles.form} onSubmit={handleSubmit}>
      ...
      {step === 1 && (
        <>
          <Field label="Entry Type" required>
            <Dropdown placeholder="Select entry type" value={formData.entryType} onOptionSelect={(_, data) => handleChange("type", data.optionValue || "")}>
      ...
      {step === 2 && (
        <>
          ...
          <Dropdown placeholder="Select timeframe" value={formData.timeframe} onOptionSelect={(_, data) => handleChange("timeframe", data.optionValue || "")}>
          ...
          <Field label="Start" required={["estimated", "confirmed"].includes(formData.timeframe.toLowerCase())}>
          <Input
            type="date"
          ...
          <Field label="End" required={["estimated", "confirmed"].includes(formData.timeframe)}>
          <Input
            type="date"
          ...
          <Field label="Scheduling Notes">
            <Textarea
              // value={formData.summary}
              onChange={(_, data) => handleChange("schedulingNotes", data.value)}
      ...
      {step === 3 && (
        ...
        <Field label="Event Lead Organization">
          ...
          <Field label="Event Planner">
            <Dropdown placeholder="Select planner" 
